<?php
$videos = [
  "Music Video" => "QmUeg6X9qMVJJzjzgsKt9eVLDnSPW53BvmCCZeYKbUat7M"
];
?>
<h2>Stored Videos</h2>
<ul>
<?php foreach($videos as $title => $cid): ?>
  <li>
    ...
    <a href="http://192.168.50.101:8080/ipfs/<?php echo $cid; ?>" target="_blank">IPFS Link</a>
  </li>
<?php endforeach; ?>
</ul>
<h2>Live Stream</h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var videoSrc = 'http://192.168.50.101/stream.m3u8';
    if (Hls.isSupported()) {
        var hls = new Hls();
